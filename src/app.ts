import {
  ...
  LocalStorageUnloadKey,
  printRecentLocalStoredAppContext,
  handleReloadOnUnload,
  appCacheMode,
...
const initializeAppModules = () => {
  ...
  addModule({
    ...
    hasOutput: false,
    action: function () {
      microsoftTeams.teamsCore.enablePrintCapability();
    },
  });
  ...
  addModule({
    ...
    hasOutput: false,
    action: function () {
      microsoftTeams.teamsCore.print();
    },
  });
  ...
  addModule({
    ...
    hasOutput: true,
    action: function (output) {
      microsoftTeams.pages.tabs.getTabInstances()
      .then(output);
    },
  });
  ...
  addModule({
    ...
    hasOutput: true,
    action: function (output) {
      microsoftTeams.pages.tabs.getMruTabInstances()
      .then(output);
    },
  });
  ...
  addModule({
    ...
    action: function (url) {
      microsoftTeams.pages.navigateCrossDomain(url);
    },
  });
  ...
  addModule({
    ...
    hasOutput: true,
    action: function (output) {
      microsoftTeams.app.registerOnThemeChangeHandler(output);
    },
  });
  ...
  addModule({
    ...
    hasOutput: true,
    action: function (output) {
      microsoftTeams.pages.config.registerChangeConfigHandler(function () {
  ...
  addModule({
    ...
    hasOutput: true,
    action: function (output) {
      microsoftTeams.pages.appButton.onClick(function () {
  ...
  addModule({
    ...
    hasOutput: true,
    action: function (output) {
      microsoftTeams.pages.appButton.onHoverEnter(function () {
  ...
  addModule({
    ...
    hasOutput: true,
    action: function (output) {
      microsoftTeams.pages.appButton.onHoverLeave(function () {
  ...
  addModule({
    ...
    hasOutput: true,
    action: function (output) {
      microsoftTeams.pages.getConfig().then(output);
    },
  });
  ...
  addModule({
    ...
    action: function (output) {
      output("total States: " + totalStates);
      microsoftTeams.pages.backStack.registerBackButtonHandler(function () {
        if (totalStates > 0) {
          totalStates--;
          output(
  ...
  addModule({
    ...
    action: (frameContext: microsoftTeams.FrameInfo) => {
      microsoftTeams.pages.setCurrentFrame(frameContext);
    },
  });
